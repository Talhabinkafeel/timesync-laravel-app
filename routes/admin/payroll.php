...
Route::group(['middleware' => ['xss','admin', 'TimeZone'], 'prefix' => 'hrm'], function () {
   ...
   Route::controller(SalaryController::class)->prefix('payroll/salary')->group(function () {
      ...
      Route::any('/salary-sheet', 'salaryTable')->name('hrm.monthly.salary.table')->middleware('PermissionCheck:salary_invoice');
      Route::any('/get-salary-sheet', 'getSalaryTable')->name('hrm.get.monthly.salary.table')->middleware('PermissionCheck:salary_invoice');
      Route::any('/get-salary-generated-department', 'getSalaryGeneratedDepartment')->name('hrm.get.salary.generated.department')->middleware('PermissionCheck:salary_invoice');
   });
});
