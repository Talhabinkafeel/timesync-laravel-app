...
Route::group(['prefix' => 'hrm', 'middleware' => ['xss', 'admin', 'MaintenanceMode']], function () {
    ...
    Route::group(['prefix' => 'branches'], function () {
        Route::get('/', [BranchController::class, 'index'])->name('branches.index')->middleware('PermissionCheck:branch_read');
        Route::get('create-modal', [BranchController::class, 'createModal'])->name('branch.create_modal')->middleware('PermissionCheck:branch_create');
        Route::post('update/{branch}', [BranchController::class, 'update'])->name('branch.update')->middleware('PermissionCheck:branch_update');

        Route::get('create', [BranchController::class, 'create'])->name('branches.create')->middleware('PermissionCheck:branch_create');
        Route::post('store', [BranchController::class, 'store'])->name('branches.store')->middleware('PermissionCheck:branch_create');
        Route::get('edit/{branch}', [BranchController::class, 'edit'])->name('branches.edit')->middleware('PermissionCheck:branch_update');
        Route::get('delete/{branch}', [BranchController::class, 'destroy'])->name('branches.destroy')->middleware('PermissionCheck:branch_delete');
        Route::Post('change-branch', [BranchController::class, 'changeBranch'])->name('branchs.ajaxBranchChange')->middleware('PermissionCheck:branch_update');
