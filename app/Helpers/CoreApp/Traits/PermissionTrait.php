...
trait PermissionTrait
{
    ...
    public function hrPermissions(): array
    {
        ...
        $lists = [
            ...
            'report_menu',
            'location_history',
            'present_attendnace_report',
            'late_attendance_report',
            'absent_attendance_report',
            'no_checkout_report',
            'report',
    ...
    public function adminRolePermissions(): array
    {
        return [
            ...
            //report
            'report' => ['attendance_report' => 'attendance_report_read', 'live_tracking_read' => 'live_tracking_read','location_history'=>'location_history','present_attendnace_report'=>'present_attendnace_report','late_attendance_report'=>'late_attendance_report','absent_attendance_report'=>'absent_attendance_report','no_checkout_report'=>'no_checkout_report','break_report'=>'break_report', 'menu' => 'report_menu'],
            // settings
