...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        $request->validate([
            ...
            'empID.required' => 'Employe Id is required', 
            'empID.unique' => 'Employe ID is taken', 
    ...
    public function import(){
        $data['title'] =_trans('common.Import').' '. _trans('common.Employee');
        
        return view('backend.user.import_user', compact('data'));
    }
    ...
    public function postimport(Request $request){
        ...
        [
            'file.required'=>'Please upload the file to import',
        ]);
        ...
        try {
            ...
            dd($exception);
            DB::rollBack();
            Toastr::error('Something Went Wrong, Please try Again and Analyse the file first.', 'error');
            return redirect()->back();
        }


        Toastr::success('Employees Imported SuccessFully!','succes');
        return redirect() -> route('user.index');
    }
