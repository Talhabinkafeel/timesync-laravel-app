...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            Localization::class,
            // \Jmrashed\LaravelCoreAuthentication\Middleware\LaravelCoreAuthenticationMiddleware::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'MaintenanceMode' => \App\Http\Middleware\SiteMaintenanceMiddleware::class,
