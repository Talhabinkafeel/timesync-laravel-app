...
class CompanyRepository implements BaseInterface
{
    ...
    public function dataTable($request, $id = null)
    {
        ...
        //     $company = $company->whereBetween('created_at', start_end_datetime($request->from, $request->to));
        // }
        ...
        return datatables()->of($company->latest()->get())
            ->addColumn('action', function ($data) {
                ...
                if (auth()->user()->role_id == 1) {
                    $action_button .= actionButton('Delete', '__globalDelete(' . $data->id . ',`dashboard/companies/delete/`)', 'delete');
                }
    ...
    public function cloneFromCreator(){
