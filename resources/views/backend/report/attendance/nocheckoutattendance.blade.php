                        ...
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                <div class="align-self-center">
                                    ...
                                    @endphp
                                    <input type="hidden" value="{{ $todayDateInSqlFormat }}" id="daterange-input" onchange="reportAttendanceDatatable()">
                                </div>
                                <!-- Designation -->
                                <div class="align-self-center">
...
@section('script')
    <script>
        ...
        function reportAttendanceDatatable(...values) {
            let data = [];
            let url = $("#report_nocheckout_attendance_table_url").val();
            data["url"] = url;
            let { from, to } = __date_range ?? {};
            var shortBy = $("#short_by").val();
            data["value"] = {
                from: from ? from : $('#daterange-input').val(),
                to: to ? to : $('#daterange-input').val(),
