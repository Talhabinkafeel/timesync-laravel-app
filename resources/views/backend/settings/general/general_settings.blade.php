                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="ot_fileUploader left-side mb-3">
                                                            <input class="form-control" type="text"
                                                                placeholder="{{ _trans('settings.Background Image') }}" name="" readonly=""
                                                                id="placeholder">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="ot_fileUploader left-side mb-3">
                                                            <input class="form-control" type="text"
                                                                placeholder="{{ _trans('settings.Company Logo Backend') }}" name=""
                                                                readonly="" id="placeholder2">
                                                            <div class="primary-btn-small-input">
                                                                <label class="btn btn-lg ot-btn-primary"
                                                                    for="fileBrouse2">{{ _trans('common.Browse') }}</label>
                                                                <input type="file" class="d-none form-control"
                                                                    name="company_logo_backend" id="fileBrouse2">
                                                            </div>
                                                        </div>
                                                        @if ($errors->has('company_logo_backend'))
                                                            <div class="invalid-feedback d-block">
                                                                {{ $errors->first('company_logo_backend') }}</div>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3"><label
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="ot_fileUploader left-side mb-3">
                                                            <input class="form-control" type="text"
                                                                placeholder="{{ _trans('settings.Company Logo Frontend') }}" name=""
                                                ...
                                                <div class="form-group row mb-3"><label
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="ot_fileUploader left-side mb-3">
                                                            <input class="form-control" type="text"
                                                                placeholder="{{ _trans('settings.Company Icon') }}" name="" readonly=""
                                                                id="placeholder4">
                                                            <div class="primary-btn-small-input">
                                                                <label class="btn btn-lg ot-btn-primary"
                                    ...
                                    <div class="form-group row align-items-center"><label for="AWSKeyId"
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div><input type="text" name="AWS_ACCESS_KEY_ID"
                                                    id="AWSKeyId" required="required"
                                                    placeholder="{{ _trans('settings.AWS ACCESS KEY ID') }}" autocomplete="off"
                                    ...
                                    <div class="form-group row align-items-center"><label for="AwsSecretKey"
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div><input type="text" name="AWS_SECRET_ACCESS_KEY"
                                                    ...
                                                    placeholder="{{ _trans('settings.AWS SECRET ACCESS KEY') }}" autocomplete="off"
                                                    id="AwsSecretKey"
                                                    class="form-control ot-form-control ot-input mb-3">
                                                <!---->
                                            </div>
                                    ...
                                    <div class="form-group row align-items-center"><label for="AwsDefaultRegion"
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div><input type="text" name="AWS_DEFAULT_REGION"
                                                    ...
                                                    placeholder="{{ _trans('settings.AWS DEFAULT REGION') }}" autocomplete="off"
                                                    id="AwsDefaultRegion"
                                                    class="form-control ot-form-control ot-input mb-3">
                                                <!---->
                                            </div>
                                    ...
                                    <div class="form-group row align-items-center"><label for="AwsBucket"
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div><input type="text" name="AWS_BUCKET" value="{{ env('AWS_BUCKET') }}"
                                                    required="required" placeholder="{{ _trans('settings.AWS BUCKET') }}" autocomplete="off"
                                                    id="AwsBucket"
                                                    class="form-control ot-form-control ot-input mb-3">
                                                <!---->
                                            </div>
                                    ...
                                    <div class="form-group row align-items-center"><label for="AwsEndpoint"
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div><input type="text" name="AWS_ENDPOINT"
                                                    ...
                                                    placeholder="{{ _trans('settings.AWS ENDPOINT') }}" autocomplete="off"
                                                    id="AwsEndpoint"
                                                    class="form-control ot-form-control ot-input mb-3">
                                                <!---->
                                            </div>
