                                                ...
                                                @foreach (@$data['info']['addition_detail'] as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            @else
                                                                <?= '<small class="badge badge-success">' . _trans('common.Percentage') . '</small><br>' ?>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
                                ...
                                <div class="table-content table-basic">
                                    ...
                                    class="black12">
                                        <thead class="card-header-invoice header-color">
                                            <tr>
                                                <th colspan="5" class="w-350 text-start">
                                                        {{ _trans('common.Title') }} </th>
                                                <th colspan="5" class="w-350 text-end">
                                                        {{ _trans('common.Amount') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
