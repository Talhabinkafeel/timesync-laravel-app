                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" placeholder="{{ _trans('common.Enter Name') }}" class="form-control ot-form-control ot-input" required
                                    value="{{ old('name') }}">
                                @if ($errors->has('name'))
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label for="#" class="form-label">{{ _trans('project.Progress') }}
                                    <small id="progress_percentage"> {{ _trans('common.0%') }} </small> </label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label">{{ _trans('common.Start Date') }} <span
                                        class="text-danger">*</span></label>
                                <input type="date" name="start_date" class="form-control ot-form-control ot-input"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label">{{ _trans('project.End Date') }} <span
                                        ...
                                        <input type="date" name="end_date" class="form-control ot-form-control ot-input"
                                            value="{{ date('Y-m-d') }}" required>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="content" placeholder="{{ _trans('common.Enter Description') }}" class="form-control content ot-form-control" required>{{ old('content') }}</textarea>
