                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="empID" class="form-control ot-form-control ot-input"
                                    placeholder="{{ _trans('common.empID') }}" value="{{ $data['show']->empID }}" required>
                                @if ($errors->has('empID'))
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="manager_id" class="form-select select2 change-role">
                                    <option value="">
                                        {{ _trans('common.Choose One') }}</option>
                                    @foreach ($data['managers'] as $manager)
                                        <option value="{{ $manager->id }}"
                                            {{ $data['show']->manager_id == $manager->id ? 'selected' : '' }}>
                                            {{ $manager->name }}</option>
                                    @endforeach
                                </select>
                            </div>
